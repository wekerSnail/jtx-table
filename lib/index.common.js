      ...
      layoutList.forEach(function (layout) {
        ...
        if (layout === 'header') {
          ...
          if (fixedWrapperElem) {
            ...
            wrapperElem.style.top = "".concat(footerHeight + headerHeight - 1, "px");
            fixedWrapperElem.style.height = "".concat((customHeight > 0 ? customHeight - headerHeight - footerHeight : tableHeight) + headerHeight + footerHeight - scrollbarWidth, "px");
