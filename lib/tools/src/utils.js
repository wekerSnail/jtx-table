...
var ColumnConfig = /*#__PURE__*/function () {
  function ColumnConfig($table, _vm) {
    ...
    Object.assign(this, {
      ...
      showTooltipAll: _vm.showTooltipAll,
  ...
  _createClass(ColumnConfig, [{
    ...
    value: function getTitle() {
      return UtilTools.getFuncText(this.own.label || (this.type === 'seq' || this.type === 'index' ? _conf.default.i18n('vxe.table.seqTitle') : ''));
    }
  }, {
    key: "update",
