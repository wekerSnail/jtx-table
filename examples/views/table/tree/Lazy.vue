<template>
  <div>
    ...
    <vxe-table
      ...
      :data="tableData">
      <vxe-table-column prop="name" label="Name" width="400" tree-node></vxe-table-column>
    ...
    <vxe-table
      ...
      :data="tableData2">
      <vxe-table-column type="checkbox" label="Name" width="400" tree-node></vxe-table-column>
      <vxe-table-column prop="size" label="Size"></vxe-table-column>
      <vxe-table-column prop="type" label="Type"></vxe-table-column>
      <vxe-table-column prop="date" label="Date"></vxe-table-column>
    </vxe-table>
