<template>
  <div>
    ...
    <vxe-table
      ...
      <vxe-table-column type="seq" width="60"></vxe-table-column>
      <vxe-table-column prop="name" label="Name" :edit-render="{name: 'input', attrs: {disabled: false}}"></vxe-table-column>
      <vxe-table-column prop="age" label="Age" :edit-render="{name: 'input', attrs: {disabled: false}}"></vxe-table-column>
      <vxe-table-column prop="sex" label="Sex" :edit-render="{name: 'select', options: sexList, attrs: {disabled: false}}"></vxe-table-column>
      <vxe-table-column prop="date12" label="Date" :edit-render="{name: 'input'}"></vxe-table-column>
    </vxe-table>
