<template>
  <div>
    <p class="tip">
      与
      <a class="link" href="https://www.npmjs.com/package/element-ui">element-ui</a> 组合渲染 + 使用分页
    </p>
    ...
    >
      ...
      <vxe-table-column
        prop="role"
        label="ElAutocomplete"
        width="160"
        :edit-render="{name: 'ElAutocomplete', props: {fetchSuggestions: roleFetchSuggestions}}"
      ></vxe-table-column>
      <vxe-table-column
        prop="age"
        label="ElInputNumber"
        width="160"
        :edit-render="{name: 'ElInputNumber', props: {max: 35, min: 18}}"
      ></vxe-table-column>
      <vxe-table-column
        prop="sex"
        label="ElSelect"
      ...
      <vxe-table-column
        ...
        label="ElSelect"
        width="140"
        :edit-render="{name: 'ElSelect', options: stateOptions, props: {remote: true, filterable: true, loading: stateloading, remoteMethod: remoteStateMethod}}"
      ></vxe-table-column>
      <vxe-table-column
        prop="region"
        label="ElCascader"
      ...
      <vxe-table-column
        ...
        label="ElTimeSelect"
        width="200"
        :edit-render="{name: 'ElTimeSelect', props: {pickerOptions: {start: '08:30', step: '00:15', end: '18:30'}}}"
      ></vxe-table-column>
      <vxe-table-column
        prop="flag"
        label="ElSwitch"
      ...
      <vxe-table-column
        ...
        label="ElSlider"
        width="200"
        :edit-render="{name: 'ElSlider', type: 'visible'}"
      ></vxe-table-column>
      <vxe-table-column
        prop="rate"
        label="ElRate"
...
export default {
  computed: { tableColumn () {
    return [
      ...
      { prop: 'role', label: 'ElAutocomplete', minWidth: '160', editRender: { name: 'ElAutocomplete', props: { fetchSuggestions: this.roleFetchSuggestions } } },
      { prop: 'age', label: 'ElInputNumber', minWidth: '160', editRender: { name: 'ElInputNumber', props: { max: 35, min: 18 } } },
      { prop: 'sex', label: 'ElSelect', minWidth: '160', editRender: { name: 'ElSelect', options: this.sexList } },
      { prop: 'state', label: 'ElSelect', minWidth: '160', editRender: { name: 'ElSelect', options: this.stateOptions, props: { remote: true, filterable: true, loading: this.stateloading, remoteMethod: this.remoteStateMethod } } },
      { prop: 'region', label: 'ElCascader', minWidth: '160', editRender: { name: 'ElCascader', options: this.regionList } },
      { prop: 'date', label: 'ElDatePicker', minWidth: '160', editRender: { name: 'ElDatePicker', props: { type: 'date', format: 'yyyy/MM/dd' } } },
      { prop: 'date1', label: 'ElDatePicker', minWidth: '160', editRender: { name: 'ElDatePicker', props: { type: 'date', format: 'yyyy/MM/dd' } } },
      { prop: 'name', label: 'ElInput', minWidth: '140', editRender: { name: 'ElInput', autoselect: true } }
    ]
  } },
  data () {
    return {
      ...
      demoCodes: [
        ...
        <vxe-table
          ...
          <vxe-table-column prop="name" label="ElInput" min-width="140" fixed="left" :edit-render="{name: 'ElInput'}"></vxe-table-column>
          ...
          <vxe-table-column prop="state" label="ElSelect" width="140" :edit-render="{name: 'ElSelect', options: stateOptions, props: {remote: true, filterable: true, loading: stateloading, remoteMethod: remoteStateMethod}}"></vxe-table-column>
          ...
          <vxe-table-column prop="slider" label="ElSlider" width="200" :edit-render="{name: 'ElSlider', type: 'visible'}"></vxe-table-column>
