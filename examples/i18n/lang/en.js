    ...
    api: {
      ...
      table: {
        desc: {
          ...
          rowId: 'prop names for custom row data unique primary keys (row data must have a unique primary key, automatically generated by default)',
      ...
      tableColumn: {
        desc: {
          ...
          label: 'Column title (support internationalization)',
